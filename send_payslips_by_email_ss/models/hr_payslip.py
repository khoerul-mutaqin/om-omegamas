...
class HRPayslip(models.Model):
    ...
    def payslip_send_mail(self):
        ...
        # Override email_to to use private_email only, remove other recipients
        email_values = template_data.copy()
        email_values['email_to'] = self.employee_id.private_email or ''
        email_values['partner_ids'] = False
        email_values['recipient_ids'] = False
    ...
    def send_payslip_by_email_action(self):
        for rec in self:
            ...
            # Override email_to to use private_email only, remove other recipients
            email_values = template_data.copy()
            email_values['email_to'] = rec.employee_id.private_email or ''
            email_values['partner_ids'] = False
            email_values['recipient_ids'] = False
