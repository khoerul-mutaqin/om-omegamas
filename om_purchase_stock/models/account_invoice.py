    ...
    def _stock_account_prepare_anglo_saxon_in_lines_vals(self):
        ...
        for move in self:
            ...
            for line in move.invoice_line_ids:
                ...
                if line.product_id.type != 'product' or line.product_id.valuation != 'real_time' or line.product_id.cost_method != 'average':
                    continue
        ...
        for invoice in self:
            ...
            if invoice.move_type in ('in_invoice', 'in_refund', 'in_receipt'):
                valued_lines |= invoice.invoice_line_ids.filtered(
                    lambda l: l.product_id and l.product_id.cost_method != 'average')
        if valued_lines:
